...
//                            //you can see its contents by logging at console
//                            console.log(data);
////
////                        //loading location Dropdown component for new fetch
////                        var select = document.getElementById("location");
////
////
////                        //Removing items(cities) from location Dropdown before new fetch
////                        $("#location").empty();
//
//                            //loading cities to location Dropdown
...
//                        },
//                        error: function (xhr) {
//                            //xhr.responseText gives you detail error report
